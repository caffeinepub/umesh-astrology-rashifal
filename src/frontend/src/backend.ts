...
export class Backend implements backendInterface {
    ...
    async createOrUpdateRashifal(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrUpdateRashifal(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllDates(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllEntries(): Promise<Array<Rashifal>> {
        if (this.processError) {
            try {
    ...
    async getRashifalByDate(arg0: string): Promise<Array<Rashifal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRashifalByDate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
